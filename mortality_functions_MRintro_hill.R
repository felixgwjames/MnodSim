...
######################################################################################
mortality_death_rate_MRlate  <- function(pop, population_capacity, population_min_size, comp_togg, comp_impact_val, MR_death_impact_val, MR_age_impact_val, mortality_age_shiftch, age_impact_val, MR_intro, MR_intro_timepoint, intercept_pop_indiv_ID, int_togg){
